=== NEX-Forms - Contact Forms Builder, Popup Forms Builder, All Forms Builder  ===
Plugin Name: NEX-Forms - Ultimate WordPress Form Builder
Contributors: Basix
Donate link: http://codecanyon.net/item/nexforms-the-ultimate-wordpress-form-builder/7103891?ref=Basix
Tags: form, forms, form builder, forms builder, contact forms, popup forms, application forms, cost estimation forms, interactive forms, quiz forms, booking forms, paypal forms, chat forms, survey forms, calculation forms
...
Popup Forms, Interactive Forms, Multi-Step Forms, Chat Forms, Contact Forms, Survey Forms, Payment Forms, Booking Forms, Quiz Forms, any Forms.

== Description ==

### THE ONLY TRUE ALL IN ONE WORDPRESS FORM BUILDER
NEX-Forms is the best Drag an Drop WordPress Form Builder plugin for creating simple to complex forms. With tons off add-ons and features NEX-Forms is a complete online form and forms builder solution.
...
**NEX-Forms** is a **high quality** and simple to use drag and drop/single click **form builder** offering a wide range of customizability, flexibility, design and usability.
...
= Chat Forms =
Create forms with a chat like apperance and feel using built-in form animations and form styling options.
<a href="http://basixonline.net/nex-forms-wordpress-form-builder-demo/form-examples/chat-forms/">See Chat Forms Examples</a>
...
NEW: Validation Setting - Add an Input mask to your field, i.e: (999) 999-9999. The user will type and the mask will automaticcaly add the format.
...
FIXED: Field selection when running submission reports.
